...
//  projects6b constraint Layout by code
//
...
//
//        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-[label1(LabelHeight@999)]-[label2(label1)]-[label3(label1)]-[label4(label1)]-[label5(label1)]-(>=10)-|", options: [], metrics: metrics, views: viewDict))
        
        let labelsArr = [label1,label2,label3,label4,label5]
...
//            label.widthAnchor.constraint(equalTo: view.widthAnchor ,constant:  -20).isActive = true
            label.heightAnchor.constraint(equalTo: view.safeAreaLayoutGuide.heightAnchor,multiplier: (1/5),constant: -30).isActive = true
